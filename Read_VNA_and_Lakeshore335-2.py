...
def comprep():
    ...
    Instrument.opc_timeout = 100000                                   # Timeout for opc-synchronised operations
...
while count<count_max:
    ...
    s2p_filename = r'C:\s2pfilename.s2p'
    ...
    pc_filename = folder_data + '\\YBCO_in_cryostat201_2_6GHz_dark_%d_%.3fK.s2p'%(count,current_temp)                                              # Name and path of the s2p file on the PC
