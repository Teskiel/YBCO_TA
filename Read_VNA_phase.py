...
date = "20250519-TlBCO-Meas-A3-sweep input"
...
for power in Inputpowers:
    ...
    pc_filename = folder + '\\TlBCO_resonator_%ddBm_%.3fK_%d.s2p'  %(power, current_temp,count)                                              # Name and path of the s2p file on the PC
